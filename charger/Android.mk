...
include $(CLEAR_VARS)
LOCAL_SRC_FILES := healthd_board_octavi.cpp
LOCAL_MODULE := libhealthd.octavi
LOCAL_CFLAGS := -Werror
LOCAL_C_INCLUDES := \
...
include $$(CLEAR_VARS)
LOCAL_MODULE := vendor_octavi_charger_$(notdir $(1))
...
include $(CLEAR_VARS)
LOCAL_MODULE := octavi_charger_res_images
LOCAL_MODULE_TAGS := optional
