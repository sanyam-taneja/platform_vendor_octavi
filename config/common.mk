...
PRODUCT_COPY_FILES += \
    ...
    vendor/octavi/prebuilt/common/bin/50-octavi.sh:system/addon.d/50-octavi.sh \
    vendor/octavi/prebuilt/common/bin/blacklist:system/addon.d/blacklist
...
PRODUCT_COPY_FILES += \
    vendor/octavi/config/permissions/backup.xml:system/etc/sysconfig/backup.xml

# octavi-specific broadcast actions whitelist
PRODUCT_COPY_FILES += \
    vendor/octavi/config/permissions/octavi-sysconfig.xml:system/etc/sysconfig/octavi-sysconfig.xml

# init.d support
PRODUCT_COPY_FILES += \
    vendor/octavi/prebuilt/common/etc/init.d/00banner:system/etc/init.d/00banner \
    vendor/octavi/prebuilt/common/bin/sysinit:system/bin/sysinit

ifneq ($(TARGET_BUILD_VARIANT),user)
# userinit support
PRODUCT_COPY_FILES += \
    vendor/octavi/prebuilt/common/etc/init.d/90userinit:system/etc/init.d/90userinit
endif
...
PRODUCT_COPY_FILES += \
    vendor/octavi/prebuilt/common/lib/content-types.properties:system/lib/content-types.properties
...
PRODUCT_COPY_FILES += \
    vendor/octavi/config/permissions/octavi-hiddenapi-package-whitelist.xml:system/etc/permissions/octavi-hiddenapi-package-whitelist.xml

# Power whitelist
PRODUCT_COPY_FILES += \
    vendor/octavi/config/permissions/octavi-power-whitelist.xml:system/etc/sysconfig/octavi-power-whitelist.xml
